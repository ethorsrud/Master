...
block_epochs = [10,20,20,20,20,20]#[2000,4000,4000,4000,4000,4000]
...
spike_data_small = spike_data[:30,:input_length*n_samples].T
train = spike_data_small.reshape((n_samples,1,input_length,30))
"""
train_new = []
