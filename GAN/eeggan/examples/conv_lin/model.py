...
def create_disc_blocks(n_chans,base,conditional):
	...
	tmp_block = ProgressiveDiscriminatorBlock(
							  create_conv_sequence(n_featuremaps+conditional,n_featuremaps,9*2**5-1),
							  create_in_sequence(n_chans,n_featuremaps+conditional),
							  create_fade_sequence(2)
							  )
	blocks.append(tmp_block)
	tmp_block = ProgressiveDiscriminatorBlock(
							  create_conv_sequence(n_featuremaps+conditional,n_featuremaps,9*2**4-1),
							  create_in_sequence(n_chans,n_featuremaps+conditional),
							  create_fade_sequence(2)
							  )
	blocks.append(tmp_block)
	tmp_block = ProgressiveDiscriminatorBlock(
							create_conv_sequence(n_featuremaps+conditional,n_featuremaps,9*2**3-1),
							create_in_sequence(n_chans,n_featuremaps+conditional),
							create_fade_sequence(2)
							)
	blocks.append(tmp_block)
	...
	tmp_block = ProgressiveDiscriminatorBlock(
							create_conv_sequence(n_featuremaps+conditional,n_featuremaps,9*2**2-1),
							create_in_sequence(n_chans,n_featuremaps+conditional),
							create_fade_sequence(2)
							)
	blocks.append(tmp_block)
	tmp_block = ProgressiveDiscriminatorBlock(
							  create_conv_sequence(n_featuremaps+conditional,n_featuremaps,9*2-1),
							  create_in_sequence(n_chans,n_featuremaps+conditional),
							  create_fade_sequence(2)
							  )
	blocks.append(tmp_block)
