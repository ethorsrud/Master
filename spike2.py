...
print('Num. events for unit 2 = {}'.format(len(st)))
st1 = sorting.get_unit_spike_train(unit_id=2, start_frame=0, end_frame=4*30000)
print('Num. events for first four seconds of unit 2 = {}'.format(len(st1)))
